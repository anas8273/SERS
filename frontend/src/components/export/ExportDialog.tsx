      ...
      <DialogContent className="sm:max-w-md" dir="rtl">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            <Label className="text-base font-semibold">{ta('صيغة التصدير', 'Export Format')}</Label>
            <RadioGroup
          ...
          {(options.format === 'png' || options.format === 'jpg') && (
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <Label>{ta('جودة الصورة', 'Image Quality')}</Label>
              ...
              <div className="flex justify-between text-xs text-muted-foreground">
                <span>{ta('أصغر حجم', 'Smallest Size')}</span>
                <span>{ta('أعلى جودة', 'Highest Quality')}</span>
              </div>
            </div>
          )}
            ...
            <div className="space-y-4 p-4 bg-muted/50 rounded-xl">
              ...
              {options.format === 'pdf' && (
                <div className="space-y-2">
                  <Label>{ta('حجم الورق', 'Paper Size')}</Label>
                  <RadioGroup
              ...
              {options.format === 'pdf' && (
                <div className="space-y-2">
                  <Label>{ta('الاتجاه', 'Direction/Orientation')}</Label>
                  <RadioGroup
                  ...
                  >
                    <div className="flex items-center space-x-2 space-x-reverse">
                      ...
                      <Label htmlFor="portrait">{ta('عمودي', 'Portrait')}</Label>
                    </div>
                    <div className="flex items-center space-x-2 space-x-reverse">
                      <RadioGroupItem value="landscape" id="landscape" />
                      <Label htmlFor="landscape">{ta('أفقي', 'Landscape')}</Label>
                    </div>
                  </RadioGroup>
                </div>
              )}
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-2 space-x-reverse">
                  ...
                  />
                  <Label htmlFor="header">{ta('تضمين الترويسة', 'Include Header')}</Label>
                </div>
                <div className="flex items-center space-x-2 space-x-reverse">
                  <Checkbox
                    id="footer"
                  ...
                  />
                  <Label htmlFor="footer">{ta('تضمين التذييل', 'Include Footer')}</Label>
                </div>
                <div className="flex items-center space-x-2 space-x-reverse">
                  <Checkbox
                    id="watermark"
                  ...
                  />
                  <Label htmlFor="watermark">{ta('إضافة علامة مائية', 'Add Watermark')}</Label>
                </div>
              </div>
            </div>
          )}
        ...
        >
          {isExporting ? (
            ...
            <>
              ...
              {ta('تم التصدير بنجاح!', 'Exported successfully!')}
            </>
          ) : (
            <>
              <Download className="w-4 h-4" />
