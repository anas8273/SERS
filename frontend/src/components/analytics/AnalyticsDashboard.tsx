        ...
        <div>
          ...
          {change !== undefined && (
            <div className="flex items-center gap-1 mt-2">
              ...
              >
                {trend === 'up' && <TrendingUp className="w-3 h-3 ms-1" />}
                {trend === 'down' && <TrendingDown className="w-3 h-3 ms-1" />}
                {change > 0 ? '+' : ''}
                {change}%
              </span>
