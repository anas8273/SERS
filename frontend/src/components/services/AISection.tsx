                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-sm font-bold">
                            ...
                            <span>{ta('مدعوم بالذكاء الاصطناعي', 'AI-powered')}</span>
                        </div>

                        <h2 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white leading-tight">
                            {ta('مساعدك الذكي', 'Your AI Assistant')}<br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">
                                {ta('لإنجاز المهام بسرعة', 'To complete tasks quickly')}
                            </span>
                        </h2>
                        ...
                        <div className="flex flex-wrap gap-4 pt-4">
                            <Link href="/ai-assistant">
                                <Button size="lg" className="rounded-full px-8 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-xl shadow-indigo-500/20">
                                    ...
                                    {ta('جرب المساعد الذكي', 'Try the Smart Assistant')}
                                </Button>
                            </Link>
                            <Link href="/services">
                                <Button size="lg" variant="outline" className="rounded-full px-8 border-2">
                                    {ta('استكشف الخدمات', 'Explore Services')}
                    ...
                    <div className="relative">
                        <div className="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 border border-gray-100 dark:border-gray-700">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div className="bg-gray-100 dark:bg-gray-700 rounded-2xl rounded-tr-none p-4 max-w-[80%]">
                                        <p className="text-gray-700 dark:text-gray-300 text-sm">
                                            {ta('مرحباً! أنا مساعدك الذكي. كيف يمكنني مساعدتك اليوم؟', 'Hello! I am your smart assistant. How can I help you today?')}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-3 justify-end">
                                    <div className="bg-indigo-600 text-white rounded-2xl rounded-tl-none p-4 max-w-[80%]">
                                        <p className="text-sm">
                                            {ta('أريد إنشاء خطة علاجية لطالب متعثر في الرياضيات', 'I want to create a remedial plan for a student struggling in math')}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div className="bg-gray-100 dark:bg-gray-700 rounded-2xl rounded-tr-none p-4 max-w-[80%]">
                                        <p className="text-gray-700 dark:text-gray-300 text-sm mb-3">
                                            {ta('سأساعدك في إنشاء خطة علاجية مخصصة. دعني أسألك بعض الأسئلة:', 'I will help you create a customized remedial plan. Let me ask you a few questions:')}
                                        </p>
                                        <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                                            <li className="flex items-center gap-2">
                                                <Sparkles className="w-4 h-4 text-indigo-500" />
                                                {ta('ما هو الصف الدراسي؟', 'What is the grade level?')}
                                            </li>
                                            <li className="flex items-center gap-2">
                                                <Sparkles className="w-4 h-4 text-indigo-500" />
                                                {ta('ما هي المهارات المتعثر فيها؟', 'What are the struggling skills?')}
                                            </li>
                                            <li className="flex items-center gap-2">
                                                <Sparkles className="w-4 h-4 text-indigo-500" />
                                                {ta('كم المدة المتاحة للخطة؟', 'How long is the plan duration?')}
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div className="mt-6 flex gap-3">
                                <input
                                    type="text"
                                    placeholder={ta('اكتب رسالتك...', 'Type your message...')}
