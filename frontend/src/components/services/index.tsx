    ...
    <section className="py-16 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">{ta('خدماتنا التعليمية', 'Our Educational Services')}</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            {ta('مجموعة شاملة من الأدوات والخدمات المصممة خصيصاً لتلبية احتياجات المعلمين والمدارس', 'Comprehensive tools and services designed specifically for teachers and schools')}
          </p>
        </div>
        ...
        <div className="text-center mt-10">
          <Link href="/services">
            <Button variant="outline" size="lg">
              {ta('عرض جميع الخدمات', 'View All Services')}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full text-primary text-sm font-medium mb-6">
              ...
              {ta('مدعوم بالذكاء الاصطناعي', 'AI-powered')}
            </div>
            <h2 className="text-3xl font-bold mb-4">
              {ta('ذكاء اصطناعي يفهم احتياجاتك', 'AI that understands your needs')}
            </h2>
          ...
          <div className="relative">
            <div className="aspect-square bg-gradient-to-br from-primary/20 to-primary/5 rounded-3xl flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">{ta('مساعدك الذكي', 'Your AI Assistant')}</p>
              </div>
            </div>
