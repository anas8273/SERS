      ...
      <div className="bg-white dark:bg-gray-800 h-full w-full max-w-md shadow-xl">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-bold text-gray-900 dark:text-white">{ta('سجل التغييرات', 'Changelog')}</h3>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-4 overflow-y-auto h-[calc(100%-64px)]">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">{ta('لا يوجد سجل تغييرات', 'No version history')}</p>
            </div>
          ) : (
