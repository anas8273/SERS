                ...
                <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl w-full max-w-xl overflow-hidden border border-white/20 dark:border-gray-800">
                    <div className="p-8 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gradient-to-r from-primary/5 to-transparent">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-xl font-black text-gray-900 dark:text-white">{ta('المساعد الذكي', 'AI Assistant')}</h3>
                                <p className="text-xs font-bold text-primary uppercase tracking-widest">{ta('مدعوم بتقنيات GPT-4', 'Powered by GPT-4')}</p>
                            </div>
                        </div>
                    ...
                    <div className="p-8 space-y-6">
                        <div className="space-y-2">
                            <h4 className="text-lg font-black text-gray-900 dark:text-white flex items-center gap-2">
                                ...
                                {ta('كيف يمكنني مساعدتك؟', 'How can I help you?')}
                            </h4>
                            <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                                {ta('يمكنني تحليل قالب', 'I can analyze a template')}<span className="font-bold text-primary">"{template.name_ar}"</span> {ta('وتوليد محتوى تعليمي احترافي ومتكامل لكل الحقول بضغطة زر واحدة.', 'and generate professional educational content for all fields with one click.')}
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <div className="p-5 bg-primary/5 dark:bg-primary/10 rounded-3xl border border-primary/10 space-y-3">
                                <div className="flex items-center gap-2 text-primary font-black text-sm">
                                    ...
                                    {ta('المميزات الذكية:', 'Smart Features:')}
                                </div>
                                <ul className="text-xs text-gray-600 dark:text-gray-300 space-y-2">
                                    <li className="flex items-center gap-2">
                                        <div className="w-1.5 h-1.5 bg-primary rounded-full" />
                                        {ta('تحليل سياق السجل التعليمي وعنوانه', 'Analyze the educational record context and title')}
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <div className="w-1.5 h-1.5 bg-primary rounded-full" />
                                        {ta('توليد أهداف تعليمية وأنشطة مبتكرة', 'Generate educational objectives and innovative activities')}
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <div className="w-1.5 h-1.5 bg-primary rounded-full" />
                                        {ta('تنسيق النصوص بأسلوب تربوي رصين', 'Format texts in a professional educational style')}
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <Button
                            ...
                            onClick={async () => {
                                ...
                                try {
                                    ...
                                    logger.error('AI Fill All Error:', err);
            ...
            <div className="bg-white dark:bg-gray-900 rounded-[2rem] shadow-2xl w-full max-w-md overflow-hidden border border-gray-100 dark:border-gray-800">
                <div className="p-6 border-b border-gray-50 dark:border-gray-800 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-black text-gray-900 dark:text-white">{ta('اقتراح ذكي', 'Smart Suggestion')}</h3>
                    </div>
                ...
                <div className="p-6 space-y-4">
                    {!suggestion && !isLoading && (
                        <div className="space-y-4">
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                {ta('سأقوم بكتابة محتوى إبداعي لهذا الحقل بناءً على السياق التعليمي.', 'I will write creative content for this field based on the educational context.')}
                            </p>
                            <Button 
                            ...
                            >
                                <Wand2 className="w-4 h-4" />
                                {ta('ابدأ التوليد', 'Start Generation')}
                            </Button>
                        </div>
                    )}
                    ...
                    {isLoading && (
                        <div className="py-10 flex flex-col items-center justify-center gap-4">
                            ...
                            <p className="text-sm font-bold text-gray-500 animate-pulse">{ta('جاري التفكير في محتوى إبداعي...', 'Thinking of creative content...')}</p>
                        </div>
                    )}
                        ...
                        <div className="space-y-4 animate-slide-up">
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    ...
                                    {ta('قبول وتطبيق', 'Accept and Apply')}
                                </Button>
                                <Button
                                    variant="outline"
                                    onClick={getFieldSuggestion}
