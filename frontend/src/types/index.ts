...
export interface Template {
    ...
    section?: Section;
    section_id?: string;
    thumbnail?: string;           // raw storage path
    thumbnail_url: string | null; // computed full URL
    preview_images?: string[];
    ready_file?: string;
    external_link?: string;       // external URL (Google Drive, etc.)
    educational_stage?: string;
    subject?: string;
    tags?: string[];
    is_free: boolean;             // free templates don't require purchase
    is_featured: boolean;
    is_active: boolean;
    created_at: string;
...
export interface ServiceDefinition {
    ...
    category: string;
    route: string;
    /** 'interactive' = has dedicated admin CRUD page, 'static-tool' = standalone PDF/tool page, 'display' = display-only link */
    service_type?: 'interactive' | 'static-tool' | 'display';
    /** Admin page href (e.g. '/admin/educational-services/work-evidence') */
    admin_href?: string;
    /** Number of sub-items (records, forms, etc.) — set dynamically at runtime */
    sub_count?: number;
...
// ============================================================
// STATIC TOOLS TYPES (Dynamic CMS for Educational Tools)
// ============================================================

/** A single form field inside a static tool's form */
...
export interface StaticTool {
    ...
    icon: string;
    gradient: string;
    href: string;                  // public page route e.g. /documentation-forms
    sort_order: number;
    is_active: boolean;
    forms: StaticForm[];
