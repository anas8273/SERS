...
// Client-side parsing using xlsx (lazy) and papaparse
// Supports Arabic column names and RTL data
// ============================================================

// xlsx is imported statically for reliability
...
/**
 * Parse Excel file using xlsx library (dynamically loaded)
 */
...
/**
 * Parse CSV file using papaparse (dynamically loaded)
 */
...
/**
 * Generate a sample Excel template for download (lazy XLSX)
 */
...
/**
 * Export data as Excel file (lazy XLSX)
 */
export function exportToExcel(data: Record<string, unknown>[], fileName: string = 'export'): void {
  const XLSX = getXLSX();
...
/**
 * Get sheet names from Excel file (lazy XLSX)
 */
