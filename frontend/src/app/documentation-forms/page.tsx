...
/**
 * documentation-forms/page.tsx — Thin shell wrapper
 *
 * The actual page content (2,400+ lines) is loaded lazily via next/dynamic.
 */
...
const DocumentationFormsContent = dynamic(
    () => import('./_DocumentationFormsContent'),
    { loading: () => <Skeleton />, ssr: false }
);

export default function DocumentationFormsPage() {
    return <DocumentationFormsContent />;
}
