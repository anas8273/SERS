...
export default function EditorPage() {
  const { dir } = useTranslation();
    ...
    const handleAcceptSuggestion = (fieldName: string, suggestion: string) => {
        ...
        toast.success(ta('تم قبول الاقتراح', 'Suggestion accepted'));
    };

    if (!record) {
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className="animate-pulse w-12 h-12 rounded-2xl bg-primary/20"></div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <header className="bg-white border-b sticky top-0 z-10">
                <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
                    <h1 className="text-xl font-bold">{ta('تحرير السجل', 'Edit Record')}</h1>
