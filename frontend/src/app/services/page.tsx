...
const SERVICE_CATEGORIES = [
    { id: 'all', name: 'جميع الخدمات', icon: Layers, color: 'bg-gray-500' },
    ...
    { id: 'ai', name: 'الذكاء الاصطناعي', icon: Bot, color: 'bg-purple-500' },
];
...
const SERVICES = [
    {
        ...
        description: 'تحليل نتائج الاختبارات واستخراج التقارير والإحصائيات التفصيلية',
        icon: BarChart3,
        color: 'bg-blue-500',
        gradient: 'from-blue-500 to-blue-600',
        features: ['تحليل درجات الطلاب', 'استخراج الإحصائيات', 'تحديد نقاط القوة والضعف', 'تقارير مفصلة', 'رسوم بيانية تفاعلية'],
    ...
    },
    {
        ...
        description: 'إنشاء شهادات الشكر والتقدير والتخرج بتصاميم احترافية متعددة',
        icon: Award,
        color: 'bg-amber-500',
        gradient: 'from-amber-500 to-orange-500',
        features: ['شهادات تقدير', 'شهادات شكر', 'شهادات تخرج', 'إنشاء متعدد', 'قوالب احترافية'],
    ...
    },
    {
        ...
        description: 'إنشاء الخطط العلاجية والإثرائية وتوزيع المنهج بسهولة',
        icon: ClipboardList,
        color: 'bg-green-500',
    ...
    },
    {
        ...
        description: 'إدارة تقييمات الأداء الوظيفي وشواهد الأداء للمعلمين',
        icon: Target,
        color: 'bg-red-500',
    ...
    },
    {
        ...
        description: 'مساعد ذكي يساعدك في إعداد الخطط والتقارير باستخدام الذكاء الاصطناعي',
        icon: Bot,
        color: 'bg-indigo-500',
...
// الإحصائيات العامة
const GENERAL_STATS = [
    { label: 'خدمة متاحة', value: SERVICES.length, icon: Zap, color: 'bg-blue-100 text-blue-600' },
    { label: 'خدمة شائعة', value: SERVICES.filter(s => s.isPopular).length, icon: Star, color: 'bg-yellow-100 text-yellow-600' },
    { label: 'خدمة جديدة', value: SERVICES.filter(s => s.isNew).length, icon: Sparkles, color: 'bg-green-100 text-green-600' },
    { label: 'خدمة ذكية', value: SERVICES.filter(s => s.category === 'ai').length, icon: Bot, color: 'bg-purple-100 text-purple-600' },
];
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900" dir="rtl">
            ...
            <main className="container mx-auto py-8 px-4">
                ...
                <div className="max-w-xl mx-auto mb-10">
                    <div className="relative">
                        ...
                        <Input
                            ...
                            className="pr-12 py-6 text-lg rounded-2xl border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm"
                            value={searchQuery}
                ...
                {activeCategory === 'all' && searchQuery === '' && (
                    <div className="mb-12">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <Link href="/services?category=popular" className="text-primary hover:underline text-sm font-medium flex items-center gap-1">
                                عرض الكل
                ...
                {/* AI Features Section */}
                {activeCategory === 'all' && searchQuery === '' && (
                    <Card className="bg-gradient-to-br from-indigo-600 via-purple-600 to-violet-700 text-white overflow-hidden border-0 shadow-2xl">
