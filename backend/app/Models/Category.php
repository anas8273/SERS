 ...
 * Category Model
 * 
 * Represents job-role based categories (الإدارة المدرسية, التربية الخاصة, etc.)
 * Categories are independent entities — NOT sub-categories of sections.
 * Uses UUID as primary key for consistency across the system.
 * 
 * @property string $id UUID primary key
 * @property string|null $section_id Optional FK to sections table (nullable - categories are independent)
