...
class Review extends Model
{
    ...
    /**
     * [FIX Q-04] Register model events.
     * On soft-delete, re-sync the template's cached rating
     * so that deleted reviews don't skew the displayed average.
     */
    protected static function boot(): void
    {
        ...
        static::deleted(function (Review $review) {
            // Only re-sync if the deleted review was approved (it affected the public rating)
            if ($review->is_approved) {
                $review->syncTemplateCachedRating();
            }
        });
    }
    ...
    public function approve(): void
    {
        ...
        // [FIX BUG-NEW-01] Sync template cached rating after approval
        $this->syncTemplateCachedRating();
    }
    ...
    public function reject(): void
    {
        ...
        // [FIX BUG-NEW-01] Sync template cached rating after rejection
        $this->syncTemplateCachedRating();
    }

    /**
     * Re-compute and store the template's approved-review aggregates.
     * Called after approve/reject so Template::average_rating is always fresh.
     * Uses a single aggregate query to stay efficient.
     */
    private function syncTemplateCachedRating(): void
    {
        $stats = static::where('template_id', $this->template_id)
