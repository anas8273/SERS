    ...
    protected static function boot()
    {
        ...
        static::creating(function ($order) {
            if (empty($order->order_number)) {
                // [FIX P3-02] Use Str::uuid() instead of uniqid() — collision-proof on distributed systems
                $order->order_number = 'ORD-' . date('Y') . '-' . strtoupper(substr(str_replace('-', '', Str::uuid()), 0, 12));
            }
        });
    }
