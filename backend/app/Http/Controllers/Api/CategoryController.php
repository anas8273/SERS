 ...
 * CategoryController
 * 
 * @deprecated This controller manages MySQL categories which are NO LONGER used for template organization.
 * Firestore service_categories is now the single source of truth for categories.
 * Templates reference Firestore category IDs via the category_id column.
 * This controller and its routes are kept temporarily for backward compatibility.
...
class CategoryController extends Controller
{
    ...
    public function adminIndex(): JsonResponse
    {
        $categories = Category::query()
            ->with(['section', 'children' => function ($q) {
                $q->ordered()->withCount('templates');
            }])
            ->withCount('templates')
            ->ordered()
            ->get();
    ...
    /**
     * Show single category for admin (including inactive).
     * 
