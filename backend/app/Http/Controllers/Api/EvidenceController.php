...
class EvidenceController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'file' => 'required_if:type,image|nullable|file|image|mimes:jpg,jpeg,png,gif,webp|max:5120',
            'document' => 'required_if:type,document|nullable|file|mimes:pdf,doc,docx,ppt,pptx,xls,xlsx|max:10240',
