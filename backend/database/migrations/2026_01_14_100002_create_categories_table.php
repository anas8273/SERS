...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('categories', function (Blueprint $table) {
            ...
            // Section Relationship - Categories belong to Sections (nullable for standalone categories)
            $table->uuid('section_id')->nullable()->comment('FK to sections table');

            // Multilingual Names
            $table->string('name_ar')->comment('Category name in Arabic');
            $table->string('name_en')->nullable()->comment('Category name in English');
